...
- [x] 02-02-PLAN.md — Deny list data model (Prisma) and CRUD API in Node backend
...
- [x] 02-06-PLAN.md — Gap closure: fix Presidio model loading crash, add Dockerfile.test for test execution
- [ ] 02-07-PLAN.md — Gap closure: fix mapping reconstruction in tests, harden desanitization logic
- [ ] 02-08-PLAN.md — Gap closure: fix AD_OBJECT overlap resolution, repeated-entity consistency, Portuguese language detection
...
**Success Criteria** (what must be TRUE):
  ...
  8. Per-feature model configuration allows different Claude models for Template Adapter (Sonnet 4.5) and Executive Reports (Opus 4.6)
**Plans**: 3 plans
