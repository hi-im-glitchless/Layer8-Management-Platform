...
| Entities with markdown notes reuse one shape: `notes` + `notesUpdatedAt` + `notesUpdatedBy` | 2026-07-10 | Matches existing `Project` notes; avoids a separate notes table per entity |
